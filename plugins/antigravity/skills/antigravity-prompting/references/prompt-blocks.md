...
Use these blocks selectively when composing Antigravity prompts.
...
Use when Antigravity should act without asking routine questions.
...
Use when Antigravity might otherwise guess.
